...
router.post('/message', async (req, res) => {
  try {
    ...
    try {
      ...
      logger.warn('MongoDB indisponible, pas de persistance');
    }
    ...
    // Sauvegarde en base si MongoDB est disponible
    ...
    try {
      ...
      logger.warn('Impossible de sauvegarder la conversation en base');
    }
